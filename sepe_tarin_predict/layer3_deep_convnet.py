...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),
                 conv_param_1={'filter_num': 16, 'filter_size': 5, 'pad': 1, 'stride': 1},
        ...
        pre_node_nums = np.array([1 * 3 * 3, 16 * 3 * 3,  32 * 3 * 3, 64 * 4 * 4, hidden_size])
        ...
        self.params['W4'] = wight_init_scales[3] * np.random.randn(576, hidden_size)
